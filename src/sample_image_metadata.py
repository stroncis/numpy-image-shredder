...
DEFAULT_SAMPLE_IMAGES_DATA = [
    ...
    },
    {
        ...
        "source_url": "https://www.leboncoin.fr/ad/livres/2856453141",
    ...
    },
    {
        ...
        "source_url": "https://stockcake.com/i/botanical-leaf-tapestry_2190014_1262920",
    ...
    },
    {
        ...
        "source_url": "https://dinopixel.com/checker-board-pixel-art-9080",
    ...
    },
    {
        ...
        "source_url": "https://stockcake.com/i/vibrant-flower-collection_1061865_1157624",
        "license": "Public domain (Stockcake)",
        "scraping": {
            "image_selector_regex": "<picture\\s+id=\"mainImageContainer\">.*?<img.*?src=\"([^\"]+)\".*?</picture>",
            "url_transform_regex": "_large(/[^/]+?stockcake\\.jpg)",
    ...
    },
    {
        ...
        "source_url": "https://commons.wikimedia.org/wiki/File:Yellow_flowers_a.jpg",
